             ...
             <form action="{{ url('/admin/goodsDetail') }}" method="get">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr class="parent">
                  ...
                  <td class="webname"><a href="">{{ $val->webname }}</a> </td> 
                  <td class="weburl">{{ $val->weburl }}</td>  
                  <td class="picture"><img style="width:50px;height:50px" src="/uploads/avatar/{{ $val->logo }}"></td> 
                  <td class="status">{{ $val->status }}</td> 
                  <td> 
                  <a href="{{ url('/admin/link') }}/{{ $val->id }}/edit">编辑</a> 
