      ...
      <div class="col-md-4 col-md-offset-6">
        ...
        @foreach($data as $key=>$val)
                <tr class="parent">
                  ...
                  <td>{{ $val->email }}</td>
                  <td><img style="width:50px;height:50px;" src="/uploads/avatar/{{ $val->photo }}"></td>
                  <td><button class="tds">{{ $val->status == 1 ? '开启' : '禁用'}}</button></td>
                  <td><a href="{{ url('/admin/user/edit') }}/{{ $val->id }}">编辑</a> <a href="#" class="del" data-toggle="modal" data-target="#myModal">删除</a></td>
                </tr>
        @endforeach
