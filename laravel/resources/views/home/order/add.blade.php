    ...
    <div class="mzcontainer">
        ...
        <ul class="layout-header-right">
            ...
            <li class="layout-header-service-item layout-header-service-cart" id="layoutHeaderCart">
                <a class="layout-header-service-link" href="{{ url('/home/shopcar/index') }}" data-mtype="wmz_public_yt_cart">
                    <i class="layout-font layout-font-cart1"></i> 
                    <img style="width:60px;height:60px" src="{{ asset('/uploads/logo/1.jpg') }}">
                </a>
            </li>
...
<li class="order-address-checkbox add">
  ...
  <td class="order-product-table-name">
    <a target="_blank" class="order-product-link" href="" data-mdesc="确认订单信息" data-mtype="store_se_ord">
      <img class="order-product-image" src="/uploads/avatar/{{ $val->picture }}">
    </a>
    </td>
    ...
    <div class="order-product-name">
      <a target="_blank" class="order-product-link" href="" data-mdesc="确认订单信息" data-mtype="store_se_ord">
        <p class="order-product-name-item">{{ $val->name }}</p> 
  ...
  <td class="order-product-table-price">
    <p>
      <span class="order-product-price">{{ $val->price }}</span>
  ...
  <td class="order-product-table-total">
    <p class="order-product-price red total">{{ $val->total }}</p>
  </td>
