                ...
                <div class="list">
                    <ul class="clr">
						...
						<li>
							<div class="box">
								<div class="img">
									<a href="" date-category="26" class='sort wlaq'>{{$v->cname}}</a>
									<a href=""  target="_blank">
										<img class='lazy' data-original="" src="/uploads/article/{{$v->picture}}" title="赛门铁克将收购以色列安全公司Fireglass" alt="" />
									</a>
								</div>
								<div class="word">
									<h3>
									<a href="/home/show/{{$v->id}}" target="_blank" title="赛门铁克将收购以色列安全公司Fireglass" class="headTit">
										{{$v->atitle}}			</a>
									</h3>
									<div class="des">
										{{$v->descript}}			</div>
