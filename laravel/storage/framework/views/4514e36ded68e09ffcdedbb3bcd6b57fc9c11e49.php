      ...
      <div class="col-md-4 col-md-offset-6">
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="parent">
                  ...
                  <td class="name"><?php echo e($val->username); ?></td>
                  <td><?php echo e($val->email); ?></td>
                  <td><img style="width:50px;height:50px;" src="/uploads/avatar/<?php echo e($val->photo); ?>"></td>
                  <td><button class="tds"><?php echo e($val->status == 1 ? '开启' : '禁用'); ?></button></td>
                  <td><a href="<?php echo e(url('/admin/user/edit')); ?>/<?php echo e($val->id); ?>">编辑</a> <a href="#" class="del" data-toggle="modal" data-target="#myModal">删除</a></td>
                </tr>
